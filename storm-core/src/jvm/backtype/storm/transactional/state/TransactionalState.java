...
public class TransactionalState {
    ...
    public static TransactionalState newUserState(final Map conf, final String id, final Map componentConf) {
        return new TransactionalState(conf, id, componentConf, "user");
    }

    public static TransactionalState newCoordinatorState(final Map conf, final String id, final Map componentConf) {
        return new TransactionalState(conf, id, componentConf, "coordinator");
    }

    protected TransactionalState(Map conf, final String id, final Map componentConf, final String subroot) {
        try {
    ...
    public void setData(String path, final Object obj) {
        path = "/" + path;
        final byte[] ser = _ser.serializeObject(obj);
        try {
